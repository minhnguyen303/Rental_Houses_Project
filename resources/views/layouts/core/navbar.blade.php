            ...
            <ul class="navbar-nav ml-auto">
                @auth()
                    <li class="nav-item dropdown user-account">
                        ...
                        <div class="dropdown-menu">
                            <a href="{{ route('home') }}" class="dropdown-item">Tài khoản của tôi</a>
                            <a href="{{ route('home') }}" class="dropdown-item">Đổi mật khẩu</a>
                            <a href="{{ route('home') }}" class="dropdown-item">Danh sách đặt thuê</a>
                            <a href="{{ route('home') }}" class="dropdown-item">Lịch sử thuê nhà</a>
                            <a href="{{ route('home') }}" class="dropdown-item">Payments</a>
                            <a href="{{ route('home') }}" class="dropdown-item">Đăng xuất</a>
                        </div>
                    </li>
                @else
